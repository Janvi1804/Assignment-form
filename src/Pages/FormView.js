...
function FormView() {
  ...
  const fetchForm = async () => {
    const res = await axios.get(`http://assignment-form.onrender.com/form/${id}`);
  ...
  const submitForm = async () => {
    await axios.post('http://assignment-form.onrender.com/submit-response', { formId: id, responseData: responses });
    setSubmitted(true);
  };
